    ...
    >
      <span
        ...
        className={`flex h-[28px] w-[46px] items-center rounded-full border p-[3px] transition-colors duration-200 ${
          on
            ? "border-primary-glow/40 bg-gradient-to-b from-primary-glow to-primary shadow-[0_6px_18px_-6px_rgba(34,195,135,0.7)]"
            : "border-white/10 bg-white/[0.06]"
        }`}
      >
        <span
          className={`h-[20px] w-[20px] rounded-full transition-transform duration-200 ${
            on ? "translate-x-[18px] bg-[#04120c]" : "translate-x-0 bg-ink-dim"
          }`}
        />
      </span>
    </button>
