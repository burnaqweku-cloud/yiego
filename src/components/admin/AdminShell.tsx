...
import { ArrowLeft, BadgeDollarSign, Bot, BriefcaseBusiness, ChevronDown, ChevronRight, ClipboardList, Gauge, LogOut, Menu, Store, Tags, WalletCards, X, type LucideIcon } from "lucide-react";
...
const sections: AdminNavSection[] = [
  ...
  { label: "Operations", icon: ClipboardList, items: [{ label: "Order management", to: "/admin/orders", icon: ClipboardList }] },
...
function sectionFor(pathname: string) {
  ...
  if (pathname.startsWith("/admin/orders") || pathname.startsWith("/admin/reviews")) return "Operations";
...
function AdminBrand() {
  return <NavLink to="/admin" className="flex items-center gap-3" aria-label="YieGo Admin overview"><Monogram size={42} /><div className="leading-tight"><p className="font-display text-[17px] font-semibold text-white">YieGo Admin</p><p className="mt-0.5 text-[11px] text-faint-foreground">Phase 1 operations</p></div></NavLink>;
}
