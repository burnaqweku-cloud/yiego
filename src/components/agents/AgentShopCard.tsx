...
export default function AgentShopCard() {
  ...
  const copy = state === "active" ? { k: "Your store", t: "Open your agent dashboard", d: "Today's sales, earnings, prices and your share link.", cta: "Dashboard", to: "/agent" }
    : state === "unpaid" ? { k: "Agent", t: "Your store is ready to open", d: "Pay the monthly fee and start selling at agent prices.", cta: "Pay now", to: "/agent" }
    : { k: "Become an agent", t: "Get data cheaper", d: "MTN 1GB at 4.00 instead of 4.15, 10GB at 40.00 — for yourself or to sell. From 3.00 a month.", cta: "Apply", to: "/agents" };
  return (
