        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="icon" onClick={() => navigate('/agent/bulk-purchase')}>
            ...
            <div className="space-y-2.5">
              {filtered.map(order => (
                <Card
                  ...
                  onClick={() => navigate(`/agent/bulk-purchase/orders/${order.order_id}`)}
                >
...
export default AgentWholesaleHistory;
