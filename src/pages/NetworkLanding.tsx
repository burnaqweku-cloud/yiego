...
const LANDING_CONFIGS: Record<string, LandingConfig> = {
  'buy-mtn-data-bundles-ghana': {
    network: 'MTN',
    title: 'Buy MTN Data Bundles in Ghana — Affordable Prices | YieGo',
    ...
    seoDescription: 'Buy cheap MTN data bundles in Ghana online on YieGo. All MTN bundles valid for 90 days. Fast delivery, secure MoMo payment.',
    intro: 'Get the best prices on MTN Ghana data bundles. All MTN bundles on YieGo are valid for 90 days. Secure Paystack payments via Mobile Money (MoMo) and cards.',
    ...
    faqs: [
      ...
      { question: 'How long are MTN bundles valid?', answer: 'All MTN bundles purchased on YieGo are valid for 90 days from purchase.' },
      { question: 'How to buy MTN data online in Ghana?', answer: 'Visit yiego.com, select MTN, choose your bundle size, enter the recipient\'s MTN number, and pay with Mobile Money or card.' },
      { question: 'Can I buy MTN data for someone else?', answer: 'Yes — just enter the recipient\'s MTN number at checkout.' },
      { question: 'What if my bundle doesn\'t arrive?', answer: 'Failed orders are automatically refunded. If you\'ve waited 12+ hours and nothing arrived, contact support@yiego.com or live chat.' },
    ],
  },
  'buy-telecel-data-bundles-ghana': {
    network: 'Telecel',
    title: 'Buy Telecel Data Bundles in Ghana — Best Prices | YieGo',
    ...
    seoDescription: 'Buy cheap Telecel data bundles in Ghana on YieGo. Non-expiry bundles. Fast delivery, secure payments.',
    intro: 'Looking for affordable Telecel data bundles in Ghana? Telecel bundles on YieGo are non-expiry — your data stays on the line until you use it. Pay with MoMo, card, or YieGo wallet.',
  ...
  'buy-airteltigo-data-bundles-ghana': {
    network: 'AirtelTigo',
    title: 'Buy AirtelTigo Data Bundles in Ghana — Cheapest Prices | YieGo',
    ...
    seoDescription: 'Buy affordable AirtelTigo data bundles in Ghana online. Non-expiry bundles, fast delivery on YieGo.',
    intro: 'AirtelTigo offers some of the most affordable data in Ghana. All AirtelTigo bundles on YieGo are non-expiry — your data stays on the line until you use it.',
  ...
  'cheap-data-bundles-ghana': {
    title: 'Cheap Data Bundles in Ghana — Compare MTN, Telecel & AirtelTigo | YieGo',
    ...
    faqs: [
      ...
      { question: 'Where can I buy cheap data bundles in Ghana?', answer: 'YieGo offers competitive prices on all networks at much lower rates than buying direct.' },
  ...
  'buy-data-online-ghana': {
    title: 'Buy Data Online in Ghana — All Networks | YieGo',
    ...
    seoDescription: 'Buy data online in Ghana for MTN, Telecel & AirtelTigo. No signup required. Secure MoMo payment on YieGo.',
    intro: 'Buy data bundles online in Ghana without leaving your home. YieGo supports all major networks — MTN, Telecel, and AirtelTigo — with secure Mobile Money and card payments. No account required.',
    keywords: 'buy data online Ghana, online data Ghana, data top up Ghana',
    faqs: [
      { question: 'Can I buy data online in Ghana without an account?', answer: 'Yes — YieGo lets you buy data as a guest. Creating an account is optional but unlocks wallet, history, and easier tracking.' },
      { question: 'What payment methods can I use to buy data online?', answer: 'MTN MoMo, Telecel Cash, AirtelTigo Money, Visa, Mastercard, and YieGo wallet — all via Paystack.' },
      { question: 'Is it safe to buy data online in Ghana?', answer: 'Yes — YieGo uses Paystack, Ghana\'s most trusted payment gateway, for all transactions.' },
    ],
  },
  'mtn-data-prices-ghana': {
    network: 'MTN',
    title: 'MTN Data Prices in Ghana 2026 — Live Bundle Prices | YieGo',
    ...
    seoDescription: 'Updated live MTN data prices in Ghana for 2026. All bundles valid for 90 days. Buy on YieGo.',
    intro: 'Check the latest live MTN Ghana data bundle prices. All MTN bundles on YieGo are valid for 90 days. See the catalog below for current prices.',
    keywords: 'MTN data prices Ghana 2026, MTN data bundle prices, MTN data rates Ghana',
    faqs: [
      { question: 'How long are MTN bundles valid?', answer: 'All MTN bundles on YieGo are valid for 90 days from purchase.' },
      { question: 'Are MTN data prices going up in 2026?', answer: 'Prices may vary. YieGo always shows current live prices.' },
      { question: 'Where can I find the cheapest MTN data?', answer: 'YieGo offers MTN data at much cheaper prices than buying direct from MTN.' },
    ],
  },
  'telecel-data-prices-ghana': {
    network: 'Telecel',
    title: 'Telecel Data Prices in Ghana 2026 — Live Prices | YieGo',
    h1: 'Telecel Data Prices in Ghana (2026)',
    description: 'Check live Telecel data bundle prices in Ghana for 2026. Non-expiry bundles on YieGo.',
    seoDescription: 'Live Telecel (formerly Vodafone) data prices in Ghana 2026. Non-expiry bundles on YieGo.',
    intro: 'View the latest live Telecel (formerly Vodafone Ghana) data bundle prices. Telecel bundles on YieGo are non-expiry.',
  ...
  'airteltigo-data-prices-ghana': {
    network: 'AirtelTigo',
    title: 'AirtelTigo Data Prices in Ghana 2026 — Live Prices | YieGo',
    h1: 'AirtelTigo Data Prices in Ghana (2026)',
    description: 'Live AirtelTigo data bundle prices in Ghana 2026. Non-expiry bundles on YieGo.',
    seoDescription: 'Live AirtelTigo data prices in Ghana 2026. Non-expiry bundles on YieGo.',
    intro: 'AirtelTigo offers some of the most affordable data bundles in Ghana. AirtelTigo bundles on YieGo are non-expiry.',
    keywords: 'AirtelTigo data prices Ghana 2026, AT data prices, AirtelTigo bundle rates Ghana',
    faqs: [
      { question: 'How long do AirtelTigo bundles last?', answer: 'AirtelTigo bundles on YieGo are non-expiry.' },
  ...
  'mtn-data-bundles-ghana': {
    network: 'MTN',
    title: 'Cheap MTN Data Bundles Ghana | Buy MTN Data Online — YieGo',
  ...
  'telecel-data-bundles-ghana': {
    network: 'Telecel',
    title: 'Cheap Telecel (Vodafone) Data Bundles Ghana | Buy Online — YieGo',
    ...
    faqs: [
      ...
      { question: 'How cheap is Telecel data on YieGo?', answer: 'YieGo prices are much cheaper than buying directly from Telecel.' },
  ...
  'airteltigo-data-bundles-ghana': {
    network: 'AirtelTigo',
    title: 'Cheap AirtelTigo Data Bundles Ghana | Buy AT Data Online — YieGo',
    ...
    faqs: [
      { question: 'How long do AirtelTigo bundles last?', answer: 'AirtelTigo bundles on YieGo are non-expiry — your data stays on the line until you use it.' },
      { question: 'Is AirtelTigo data the cheapest in Ghana?', answer: 'AirtelTigo typically has some of the lowest per-GB data prices in Ghana, and YieGo passes those savings on.' },
  ...
  'cheapest-data-bundles-ghana': {
    title: 'Cheapest Data Bundles in Ghana 2026 — Compare All Networks | YieGo',
    h1: 'Cheapest Data Bundles in Ghana (2026)',
    description: 'The cheapest data bundles in Ghana for MTN, Telecel & AirtelTigo on YieGo.',
    seoDescription: 'The cheapest data bundles in Ghana for MTN, Telecel & AirtelTigo. Compare and buy on YieGo.',
    intro: 'Looking for the cheapest data bundles in Ghana? YieGo lists every active MTN (90-day), Telecel (non-expiry) and AirtelTigo (non-expiry) bundle at our lowest live prices.',
    keywords: 'cheapest data bundles Ghana, cheapest data Ghana 2026, lowest data prices Ghana',
    faqs: [
      { question: 'Which network has the cheapest data in Ghana?', answer: 'It depends on the bundle size. AirtelTigo often wins on per-GB price. Compare them all live on YieGo.' },
      { question: 'How is YieGo cheaper than buying direct?', answer: 'YieGo sources bundles in bulk and passes the savings on. Same bundle, far lower price.' },
      { question: 'Are the prices on YieGo real-time?', answer: 'Yes — prices reflect current selling prices and update whenever supplier costs change.' },
  ...
  'buy-data-bundles-accra': {
    title: 'Buy Cheap Data Bundles in Accra — All Networks | YieGo',
    ...
    seoDescription: 'Buy cheap data bundles in Accra on YieGo. MTN, Telecel & AirtelTigo bundles delivered to any Greater Accra number.',
    intro: 'In Accra, YieGo is the easiest way to top up data. Buy MTN, Telecel or AirtelTigo bundles online and have them delivered to any number in Greater Accra — usually within a few minutes.',
    keywords: 'buy data Accra, cheap data Accra, MTN data Accra, data bundle Accra Ghana',
    faqs: [
      { question: 'Does YieGo work in all of Accra?', answer: 'Yes — YieGo delivers to any active MTN, Telecel or AirtelTigo line in Greater Accra and across Ghana.' },
    ],
  },
  'buy-data-bundles-kumasi': {
    title: 'Buy Cheap Data Bundles in Kumasi — All Networks | YieGo',
    ...
    seoDescription: 'Buy cheap data bundles in Kumasi on YieGo. MTN, Telecel & AirtelTigo bundles delivered across the Ashanti Region.',
    intro: 'Kumasi customers love YieGo for fast, cheap data. Top up MTN, Telecel or AirtelTigo bundles online from anywhere in the Ashanti Region.',
  ...
  'buy-data-bundles-tamale': {
    title: 'Buy Cheap Data Bundles in Tamale — All Networks | YieGo',
    ...
    seoDescription: 'Buy cheap data bundles in Tamale on YieGo. Delivered across the Northern Region.',
    intro: 'YieGo reaches every corner of Ghana — including Tamale. Buy cheap MTN, Telecel or AirtelTigo data online and have it delivered to your line, usually within a few minutes.',
    keywords: 'buy data Tamale, cheap data Tamale, data bundle Northern Region Ghana',
    faqs: [
      { question: 'Does YieGo serve the Northern Region?', answer: 'Yes — anywhere in Ghana with a working MTN, Telecel or AirtelTigo line.' },
    ],
  },
  'buy-data-bundles-takoradi': {
    title: 'Buy Cheap Data Bundles in Takoradi — All Networks | YieGo',
    ...
    seoDescription: 'Buy cheap data bundles in Takoradi on YieGo. Delivered across the Western Region.',
    intro: 'Takoradi residents can buy cheap data online with YieGo. MTN, Telecel and AirtelTigo bundles delivered to your line, usually within a few minutes.',
  ...
  'buy-data-bundles-cape-coast': {
    title: 'Buy Cheap Data Bundles in Cape Coast — All Networks | YieGo',
    ...
    seoDescription: 'Buy cheap data bundles in Cape Coast on YieGo. Delivered across the Central Region.',
    intro: 'Whether you\'re a student at UCC or a business owner in Cape Coast, YieGo is the easiest way to buy cheap data online. Usually delivered within a few minutes.',
    keywords: 'buy data Cape Coast, cheap data Cape Coast, data bundle Central Region Ghana',
    faqs: [
      { question: 'Is YieGo good for students?', answer: 'Yes — pick the bundle size that fits your usage. Telecel and AirtelTigo bundles never expire.' },
    ],
  },
};
