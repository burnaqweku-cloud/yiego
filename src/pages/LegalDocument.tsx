...
export default function LegalDocument() {
  ...
  if (!document) return <Card><CardContent><h1 className="font-display text-2xl font-semibold text-white">Document unavailable</h1><p className="mt-2 text-sm text-muted-foreground">This legal document is not currently published.</p></CardContent></Card>;
