  ...
  return (
    <div className="space-y-5">
      ...
      <Link to="/admin/finance/master" className="block">
        <Panel title="Master balance" icon={Landmark} note="the pot · tap for detail">
          ...
          <p className="mt-1.5 flex flex-wrap items-center gap-x-1.5 text-[11.5px] tabular-nums"><span className="text-muted-foreground">partners' money + payouts − top-ups</span><span className="text-faint-foreground">·</span><span className="text-ink-emerald">{formatGHS(Number(o?.cash.paystack_transit ?? 0))} coming from Paystack</span><span className="text-faint-foreground">·</span><span className="text-muted-foreground">net worth {formatGHS(netWorth)}</span></p>
        </Panel>
      </Link>
