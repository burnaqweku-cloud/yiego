...
const CUSTOMER_STATUSES = ["processing", "pending_supplier", "awaiting_verification", "wrong_network", "delivered", "failed", "cancelled", "refunded"];
