CREATE OR REPLACE FUNCTION public.admin_dashboard_period_totals(
  p_start timestamptz DEFAULT NULL,
  p_end   timestamptz DEFAULT NULL
)
RETURNS TABLE (
  normal_total          bigint,
  normal_delivered      bigint,
  normal_processing     bigint,
  normal_pending        bigint,
  normal_pending_payment bigint,
  normal_failed         bigint,
  normal_revenue        numeric,
  normal_profit         numeric,
  normal_gb_delivered   numeric,
  normal_mtn            bigint,
  normal_telecel        bigint,
  normal_at             bigint,
  agent_total           bigint,
  agent_delivered       bigint,
  agent_processing      bigint,
  agent_failed          bigint,
  agent_revenue         numeric,
  agent_profit          numeric,
  new_users             bigint,
  deposits_confirmed_count   bigint,
  deposits_confirmed_amount  numeric,
  deposits_pending_count     bigint,
  deposits_pending_amount    numeric,
  deposits_rejected_count    bigint,
  agent_withdrawals_pending_count  bigint,
  agent_withdrawals_pending_amount numeric
)
LANGUAGE sql
...
GRANT EXECUTE ON FUNCTION public.admin_dashboard_period_totals(timestamptz, timestamptz) TO authenticated;